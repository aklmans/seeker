...
/* ★批11B(widgetActions 契约):renderJobs 桥已摘 —— 最后一个裸读者(platform/shell/widget-actions.js 的 delete-job 分支)已整段回迁 jobseek;
   全部消费者已 import(manifest/cards/persistence/其他页/widget-actions-jobseek)。状态符号(文件本地)私有。 */
