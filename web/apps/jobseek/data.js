...
window.JOBS=JOBS; window.SKILLS=SKILLS; window.ACTIONS=ACTIONS; window.STATUS=STATUS; window.ACCRUAL=ACCRUAL; window.PRI=PRI; window.CAT_LABEL=CAT_LABEL; window.TOP_GAPS=TOP_GAPS;
