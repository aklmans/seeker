...
window.copEl=copEl; window.copOpen=copOpen; window.copClose=copClose; window.copToggle=copToggle; window.copScroll=copScroll; window.copAppend=copAppend; window.copSend=copSend; window.agentAppend=agentAppend; window.agentSend=agentSend; window.copInit=copInit; window.copGo=copGo; window.agentChat=agentChat; window.agentCancel=agentCancel; window.aiChatAvailable=aiChatAvailable; window.agentScroll=agentScroll; window.renderModeSwitch=renderModeSwitch; window.setAppMode=setAppMode; window.getAppMode=getAppMode; window.agentShowCanvas=agentShowCanvas; window.agentCollapse=agentCollapse; window.agentGreet=agentGreet; window.setAppReady=setAppReady; window.cmdIsOpen=cmdIsOpen; window.cmdFilterList=cmdFilterList; window.cmdRender=cmdRender; window.cmdOpen=cmdOpen; window.cmdClose=cmdClose; window.cmdRun=cmdRun; window.agentInit=agentInit; window.updateAgentChrome=updateAgentChrome; window.updateCopChrome=updateCopChrome; window.hydrateMessages=hydrateMessages; window.cEsc=cEsc; window.cCard=cCard; window.cAct=cAct; window.cBtn=cBtn; window.cAB=cAB; window.cSuggs=cSuggs;
